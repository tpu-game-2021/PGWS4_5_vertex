...
# 自分なりに変更した点
-ピンク→緑→オレンジ→白→...でTextureをループさせて春夏秋冬をイメージしました
-大→大→中→小→...のようにループさせ、木々が成長して枯れていくような感じをイメージしました
# この後の授業でやって欲しい事
-UnityRecorderのような、覚えておくと便利なUnityの機能などが知りたいです
-また、いまいちShederGraphの有用性がわからないので、どういった場面で活躍しうるのか教えていただけると嬉しいです
